                                        ...
                                        foreach($post_types as $post_type)
                                            {
                                                ...
                                                ?>value="<?php echo $post_type ?>"><?php echo $post_type_data->label ?> <small>(<?php echo $post_type; ?>)</small><?php
                                                    if($post_type  ==   'any')
                                                        {
                                                            ?><small> **WARNING!! This will load all post types objects. Recommended to be used with Advanced Query Rules</small><?php   
                                                        }
                                                ?></option><?php            
                                            }
                                    ...
                                    <table class="apto_input inner_table widefat">
                                        <tbody>
                                            ...
                                            <tr class="alt"><td>
                                                ...
                                                <label for="custom_field_type_signed_<?php echo $options['group_id'] ?>">Float (Decimal)</label><br>
